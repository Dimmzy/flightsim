...
std::vector<std::string> lexer::lex(std::string file) {
  ...
  for(std::string str:vectorString) {
    std::cout << str + ",";
  }
 ...
 */
void lexer::lexingTokens(std::vector<std::string>& vectorString, std::ifstream& in_file) {
